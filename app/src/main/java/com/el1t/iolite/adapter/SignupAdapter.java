...
import com.el1t.iolite.ui.SignupFragment;
 ...
 */
public class SignupAdapter extends RecyclerView.Adapter<SignupAdapter.ViewHolder> implements Filterable {
	...
	public SignupAdapter(Activity context, EighthActivity[] items) {
